...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.eurocoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.eurocointools.com", true);
        vSeeds.emplace_back("dnsseed.eurocoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.eurocointools.com", true);
        vSeeds.emplace_back("seed-b.eurocoin.loshan.co.uk", true);
