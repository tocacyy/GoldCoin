...
const char* BIP71_MIMETYPE_PAYMENT = "application/eurocoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/eurocoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/eurocoin-paymentrequest";
    ...
    if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        else // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Eurocoin address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
