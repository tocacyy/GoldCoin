...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s eurocoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  eurocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded eurocoin transaction") + "\n" +
              "  eurocoin-tx [options] -create [commands]   " + _("Create hex-encoded eurocoin transaction") + "\n" +
              "\n";
