...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/eurocoin-project/eurocoin>";
    const std::string URL_WEBSITE = "<https://eurocoin.org>";
