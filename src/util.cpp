...
const char * const BITCOIN_CONF_FILENAME = "eurocoin.conf";
const char * const BITCOIN_PID_FILENAME = "eurocoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Eurocoin";
#else
    // Unix
